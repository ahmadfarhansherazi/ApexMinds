...
const platforms = [
  { name: "LoFT 1.0 & 2.0", icon: Database },
            ...
            {platforms.map((platform, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="font-bold text-white text-center tracking-wide">
                    {platform.name}
                  </p>
                </div>
              );
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-yellow-500 to-transparent animate-move">
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-2xl font-semibold text-white py-4 text-center",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-base font-normal text-gray-300 w-full text-center px-4",
        className
      )}
    >
      {children}
