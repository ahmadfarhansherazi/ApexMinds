          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <div className="flex space-x-4 mt-4">
                <a href="https://www.linkedin.com/company/apexminds-ai/" className="hover:text-yellow-400">
                  <Linkedin size={20} />
                </a>
                <a href="https://www.facebook.com/share/1BghEckM6r/?mibextid=wwXIfr" className="hover:text-yellow-400">
                  <Facebook size={20} />
                </a>
